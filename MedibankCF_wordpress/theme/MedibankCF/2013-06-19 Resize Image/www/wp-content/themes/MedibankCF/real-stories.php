...
<!-- loop 2 guest blog -->
	...
	<!-- Only put 5 month as archive cap -->	
		  ...
		  <?php else:?>
<img src="http://localhost/medibankcf/wp-content/themes/MedibankCF/images/logo-square.jpg" class="realstoriesguestblog2 wp-post-image" alt="medibank">
		  <?php endif; ?>
...
<?php endif; ?>        
	...
	<?php if( is_page(119)) :?>
<div class="relatedLinks">
		<?php get_sidebar('BlogArchive'); ?>
	</div>
	<?php elseif(is_page(125)):?>
<div class="relatedLinks">
		<?php get_sidebar('GuestArchive'); ?>
</div>
	<?php endif;?>
        </div>
      </div>
