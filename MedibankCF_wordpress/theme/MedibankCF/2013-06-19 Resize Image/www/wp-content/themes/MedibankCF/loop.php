...
<?php /* How to display all other posts. */ ?>
	...
	<?php else : ?>
		...
		<div class="newsFeature"><!-- .entry-meta -->
			<a name="<?php the_ID(); ?>" id="<?php the_ID(); ?>" class="toHide"></a>
			<?php 
			if ( has_post_thumbnail() ) { // check if the post has a Post Thumbnail assigned to it.
				the_post_thumbnail('full', array('class' => 'limagemedia3'));
			}else{
				echo "<img src='".get_bloginfo('template_directory')."/images/logo-square.jpg' width='164' height='130' class='limagemedia3 wp-post-image'>";
			}
			?>
			   ...
			   <div class="wrap">
				...
				<?php if($_SESSION['ArchiveType'] == 'AB' || 'GB'):?>
					<div class="wrap open AGarchive"><a style="display: none; margin-top:10px;" class="readMore">Read more</a></div>
				<?php else:?>
					<div class="wrap open"><a style="display: none; margin-top:10px;" class="readMore">Read more</a></div>
				<?php endif; ?>
